...
```text
cmd /c java -jar target\agent-token-dashboard-0.1.0-SNAPSHOT.jar --report --days=7
cmd /c java -jar target\agent-token-dashboard-0.1.0-SNAPSHOT.jar --report --days=1
cmd /c java -jar target\agent-token-dashboard-0.1.0-SNAPSHOT.jar --report --month=2026-04
```

## 启动 API

```text
cmd /c java -jar target\agent-token-dashboard-0.1.0-SNAPSHOT.jar --port=18080
```
